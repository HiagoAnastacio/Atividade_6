...
fun CartaoDeVisita() {
    ...
    Column( // Usamos um Column para empilhar os elementos verticalmente
        modifier = Modifier // Modificador para aplicar estilos e comportamentos
            ...
            .padding(15.dp), // Adiciona um preenchimento de 15 dp ao redor do Column
        ...
        Text(
            text = nomeUsuario,
            style = MaterialTheme.typography.titleLarge.copy(color = textoCor, fontSize = 24.sp) // Exibe o nome do usuário com cor e tamanho personalizados
        )

        Spacer(modifier = Modifier.height(8.dp)) // Adiciona um espaço de 8 dp entre os elementos

        // Cargo do Usuário
        Text(
            text = cargoUsuario,
            style = MaterialTheme.typography.bodyMedium.copy(color = textoCor, fontSize = 15.sp) // Exibe o cargo do usuário com cor e tamanho personalizados
        )
        ...
        Row(
            modifier = Modifier
                .fillMaxWidth()
                .padding(vertical = 2.dp) // Adiciona um preenchimento vertical de 4 dp
        ) {
            Image(
                ...
                modifier = Modifier
                    ...
                    .clickable { /* Ação ao clicar no ícone de telefone */ }
            )
            Text(
                ...
                modifier = Modifier.padding(15.dp) // Adiciona um preenchimento à esquerda do texto
            )
        }
        ...
        Row(
            modifier = Modifier
                .fillMaxWidth()
                .padding(vertical = 4.dp) // Adiciona um preenchimento vertical de 4 dp
        ) {
            Image(
                ...
                modifier = Modifier
                    .size(20.dp) // Define o tamanho do ícone como 24 dp
                    .clickable { /* Ação ao clicar no ícone da rede social */ }
            )
            Text(
                text = redeSocialUsuario,
                style = MaterialTheme.typography.bodyMedium.copy(color = textoCor, fontSize = 10.sp), // Exibe o nome da rede social do usuário com cor e tamanho personalizados
                modifier = Modifier.padding(15.dp) // Adiciona um preenchimento à esquerda do texto
            )
        }
        ...
        Row(
            modifier = Modifier
                .fillMaxWidth()
                .padding(vertical = 3.dp) // Adiciona um preenchimento vertical de 4 dp
        ) {
            Image(
                ...
                modifier = Modifier
                    .size(20.dp) // Define o tamanho do ícone como 24 dp
                    .clickable { /* Ação ao clicar no ícone de email */ }
            )
            Text(
                text = emailUsuario,
